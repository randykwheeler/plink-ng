...
* build_dynamic/ contains a Makefile suitable for Linux and macOS dynamic
  ...
  * For Windows users, a step-by-step guide for compiling dynamic Linux
    builds using the Windows Subsystem for Linux (WSL) is available at
    `plink-wsl-build-walkthrough.md`.
